...
!function (t, e) {
  ...
  return function (t) {
    ...
    0: function (e, o) {
      ...
      "use strict";
      var i = o(0), n = o.n(i);
      n.a.summernote = n.a.summernote || {lang: {}}, n.a.extend(n.a.summernote.lang, {
        'zh-CN': {
          font: {
            bold: '粗体',
            italic: '斜体',
      ...
      const s = "function" == typeof define && o(2), r = ["sans-serif", "serif", "monospace", "cursive", "fantasy"];

      function a(t) {
        return -1 === n.a.inArray(t.toLowerCase(), r) ? `'${t}'` : t
      }

      const l = navigator.userAgent, c = /MSIE|Trident/i.test(l);
      let h;
      if (c) {
        let t = /MSIE (\d+[.]\d+)/.exec(l);
        t && (h = parseFloat(t[1])), t = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(l), t && (h = parseFloat(t[1]))
      }
      ...
      var y = {
        head: v, last: k, initial: function (t) {
          return t.slice(0, t.length - 1)
        }, tail: C, prev: function (t, e) {
          if (t && t.length && e) {
            const o = t.indexOf(e);
          ...
          for (let o = 0, i = t.length; o < i; o++) if (!e(t[o])) return !1;
          return !0
        }, sum: function (t, e) {
          ...
          const e = [];
          for (let o = 0, i = t.length; o < i; o++) w(e, t[o]) || e.push(t[o]);
          return e
        }
      };
      ...
      const M = $("A");
      const O = $("BODY");
      const U = f.isMSIE && f.browserVersion < 11 ? "&nbsp;" : "<br>";
      ...
      function rt(t, e) {
        ...
        const i = e && e.isNotSplitEdgePoint, n = e && e.isDiscardEmptySplits;
        ...
        {
          const e = t.node.childNodes[t.offset], i = G(t.node.cloneNode(!1), t.node);
          return Z(i, _(e)), o || (K(t.node), K(i)), n && (W(t.node) && ct(t.node), W(i)) ? (ct(i), t.node.nextSibling) : i
        }
      }

      function at(t, e, o) {
        const i = V(e.node, b.eq(t));
        return i.length ? 1 === i.length ? rt(e, o) : i.reduce((function (t, i) {
          return t === e.node && (t = rt(e, o)), rt({node: i, offset: t ? et(t) : j(i)}, o)
        })) : null
      }
      ...
      var ut = {
        ...
        isVisiblePoint: function (t) {
          ...
          const e = t.node.childNodes[t.offset - 1], o = t.node.childNodes[t.offset];
          return !(e && !T(e) || o && !T(o))
        },
        ...
        commonAncestor: function (t, e) {
          const o = V(t);
          for (let t = e; t; t = t.parentNode) if (o.indexOf(t) > -1) return t;
          return null
        },
        wrap: function (t, e) {
          const o = t.parentNode, i = n()("<" + e + ">")[0];
        ...
        splitPoint: function (t, e) {
          const o = e ? N : B, i = V(t.node, o), n = y.last(i) || t.node;
          let s, r;
          o(n) ? (s = i[i.length - 2], r = n) : (s = n, r = s.parentNode);
          let a = s && at(s, t, {isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e});
          return a || r !== t.node || (a = t.node.childNodes[t.offset]), {rightNode: a, container: r}
        },
        create: lt,
        ...
        posFromPlaceholder: function (t) {
          const e = n()(t), o = e.offset(), i = e.outerHeight(!0);
      ...
      class pt {
        ...
        triggerEvent() {
          const t = y.head(arguments), e = y.tail(y.from(arguments)),
        ...
        invoke() {
          const t = y.head(arguments), e = y.tail(y.from(arguments)), o = t.split("."), i = o.length > 1,
            n = i && y.head(o), s = i ? y.last(o) : y.head(o), r = this.modules[n || "editor"];
      ...
      function mt(t, e) {
        ...
        let s;
        const r = y.from(i.childNodes);
        for (o = 0; o < r.length; o++) if (!ut.isText(r[o])) {
        ...
        if (0 !== o && ut.isText(r[o - 1])) {
          ...
          r.nodeValue;
          e && r.nextSibling && ut.isText(r.nextSibling) && l === r.nodeValue.length && (l -= r.nodeValue.length, r = r.nextSibling), i = r, o = l
        }
      ...
      function ft(t) {
        const e = function (t, o) {
          let i, n;
          if (ut.isText(t)) {
            const e = ut.listPrev(t, b.not(ut.isText)), s = y.last(e).previousSibling;
            i = s || t.parentNode, o += y.sum(y.tail(e), ut.nodeLength), n = !s
          } else {
            if (i = t.childNodes[o] || t, ut.isText(i)) return e(i, 0);
            o = 0, n = !1
          }
          return {node: i, collapseToStart: n, offset: o}
        }, o = document.body.createTextRange(), i = e(t.node, t.offset);
        return o.moveToElementText(i.node), o.collapse(i.collapseToStart), o.moveStart("character", i.offset), o
      }

      n.a.fn.extend({
        summernote: function () {
          const t = n.a.type(y.head(arguments)), e = "string" === t, o = "object" === t,
            i = n.a.extend({}, n.a.summernote.options, o ? y.head(arguments) : {});
          i.langInfo = n.a.extend(!0, {}, n.a.summernote.lang["zh-CN"], n.a.summernote.lang[i.lang]), i.icons = n.a.extend(!0, {}, n.a.summernote.options.icons, i.icons), i.tooltip = "auto" === i.tooltip ? !f.isSupportTouch : i.tooltip, this.each((t, e) => {
            const o = n()(e);
          ...
          if (s.length) {
            ...
            if (e) return t.invoke.apply(t, y.from(arguments));
      ...
      class gt {
        ...
        nativeRange() {
          ...
          {
            const t = ft({node: this.sc, offset: this.so});
            return t.setEndPoint("EndToEnd", ft({node: this.ec, offset: this.eo})), t
          }
        }
        ...
        normalize() {
          const t = function (t, e) {
            if (!t) return t;
            if (ut.isVisiblePoint(t) && (!ut.isEdgePoint(t) || ut.isRightEdgePoint(t) && !e || ut.isLeftEdgePoint(t) && e || ut.isRightEdgePoint(t) && e && ut.isVoid(t.node.nextSibling) || ut.isLeftEdgePoint(t) && !e && ut.isVoid(t.node.previousSibling) || ut.isBlock(t.node) && ut.isEmpty(t.node))) return t;
            const o = ut.ancestor(t.node, ut.isBlock);
            let i = !1;
            if (!i) {
              const n = ut.prevPoint(t) || {node: null};
              i = (ut.isLeftEdgePointOf(t, o) || ut.isVoid(n.node)) && !e
            }
            let n = !1;
            if (!n) {
              const i = ut.nextPoint(t) || {node: null};
              n = (ut.isRightEdgePointOf(t, o) || ut.isVoid(i.node)) && e
            }
            if (i || n) {
              if (ut.isVisiblePoint(t)) return t;
              e = !e
            }
            return (e ? ut.nextPointUntil(ut.nextPoint(t), ut.isVisiblePoint) : ut.prevPointUntil(ut.prevPoint(t), ut.isVisiblePoint)) || t
        ...
        nodes(t, e) {
          t = t || b.ok;
          const o = e && e.includeAncestor, i = e && e.fullyContains, n = this.getStartPoint(), s = this.getEndPoint(),
            r = [], a = [];
        ...
        expand(t) {
          const e = ut.ancestor(this.sc, t), o = ut.ancestor(this.ec, t);
        ...
        deleteContents() {
          ...
          const t = this.splitText(), e = t.nodes(null, {fullyContains: !0}),
        ...
        wrapBodyInlineWithPara() {
          ...
          let e;
          if (ut.isInline(t.sc)) {
            const o = ut.listAncestor(t.sc, b.not(ut.isInline));
            e = y.last(o), ut.isInline(e) || (e = o[o.length - 2] || t.sc.childNodes[t.so])
          } else e = t.sc.childNodes[t.so > 0 ? t.so - 1 : 0];
          if (e) {
            let t = ut.listPrev(e, ut.isParaInline).reverse();
            if (t = t.concat(ut.listNext(e.nextSibling, ut.isParaInline)), t.length) {
              const e = ut.wrap(y.head(t), "p");
              ut.appendChildNodes(e, y.tail(t))
            }
          }
        ...
        insertNode(t) {
          ...
          const o = ut.splitPoint(e.getStartPoint(), ut.isInline(t));
        ...
        getWordRange(t) {
          ...
          const o = ut.prevPointUntil(e, (function (t) {
        ...
        getWordsRange(t) {
          var e = this.getEndPoint(), o = function (t) {
        ...
        getWordsMatchRange(t) {
          var e = this.getEndPoint(), o = ut.prevPointUntil(e, (function (o) {
            if (!ut.isCharPoint(o) && !ut.isSpacePoint(o)) return !0;
            var i = new gt(o.node, o.offset, e.node, e.offset), n = t.exec(i.toString());
            return n && 0 === n.index
          })), i = new gt(o.node, o.offset, e.node, e.offset), n = i.toString(), s = t.exec(n);
          return s && s[0].length === n.length ? i : null
        }

        bookmark(t) {
          return {
            s: {path: ut.makeOffsetPath(t, this.sc), offset: this.so},
            e: {path: ut.makeOffsetPath(t, this.ec), offset: this.eo}
          }
        }

        paraBookmark(t) {
          return {
            s: {path: y.tail(ut.makeOffsetPath(y.head(t), this.sc)), offset: this.so},
            e: {path: y.tail(ut.makeOffsetPath(y.last(t), this.ec)), offset: this.eo}
          }
        }
        ...
        create: function (t, e, o, i) {
          ...
          if (2 === arguments.length) return new gt(t, e, o = t, i = e);
          {
            ...
            if (!t && 1 === arguments.length) {
              let t = arguments[0];
              return ut.isEditable(t) && (t = t.lastChild), this.createFromBodyElement(t, ut.emptyPara === arguments[0].innerHTML)
            }
            return t
          }
        }, createFromBodyElement: function (t, e = !1) {
          ...
          if (f.isW3CRangeSupport) {
            ...
            if (ut.isBody(n.anchorNode)) return null;
            ...
            const r = n;
            r.collapse(!0);
            let a = mt(r, !0), l = mt(s, !1);
            ut.isText(a.node) && ut.isLeftEdgePoint(a) && ut.isTextNode(l.node) && ut.isRightEdgePoint(l) && l.node.nextSibling === a.node && (a = l), t = a.cont, e = a.offset, o = l.cont, i = l.offset
          }
          return new gt(t, e, o, i)
        }, createFromNode: function (t) {
          let e = t, o = 0, i = t, n = ut.nodeLength(i);
          ...
          const o = ut.fromOffsetPath(t, e.s.path), i = e.s.offset, n = ut.fromOffsetPath(t, e.e.path), s = e.e.offset;
          return new gt(o, i, n, s)
        }, createFromParaBookmark: function (t, e) {
          const o = t.s.offset, i = t.e.offset, n = ut.fromOffsetPath(y.head(e), t.s.path),
      ...
      var kt = {
        isEdit: t => y.contains([vt.BACKSPACE, vt.TAB, vt.ENTER, vt.SPACE, vt.DELETE], t),
        isMove: t => y.contains([vt.LEFT, vt.UP, vt.RIGHT, vt.DOWN], t),
        isNavigation: t => y.contains([vt.HOME, vt.END, vt.PAGEUP, vt.PAGEDOWN], t),
      ...
      class Ct {
        ...
        makeSnapshot() {
          const t = bt.create(this.editable);
          return {
      ...
      class wt {
        ...
        stylePara(t, e) {
          n.a.each(t.nodes(ut.isPara, {includeAncestor: !0}), (t, o) => {
            n()(o).css(e)
          })
        }
        ...
        styleNodes(t, e) {
          t = t.splitText();
          const o = e && e.nodeName || "SPAN", i = !(!e || !e.expandClosestSibling),
            s = !(!e || !e.onlyPartialContains);
          if (t.isCollapsed()) return [t.insertNode(ut.create(o))];
          let r = ut.makePredByNodeName(o);
          const a = t.nodes(ut.isText, {fullyContains: !0}).map(t => ut.singleChildAncestor(t, r) || ut.wrap(t, o));
          if (i) {
            if (s) {
              const e = t.nodes();
              r = b.and(r, t => y.contains(e, t))
            }
            return a.map(t => {
              const e = ut.withClosestSiblings(t, r), o = y.head(e), i = y.tail(e);
        ...
        current(t) {
          const e = n()(ut.isElement(t.sc) ? t.sc : t.sc.parentNode);
          ...
          const i = ut.ancestor(t.sc, ut.isPara);
      ...
      class yt {
        ...
        indent(t) {
          const e = bt.create(t).wrapBodyInlineWithPara(), o = e.nodes(ut.isPara, {includeAncestor: !0}),
        ...
        outdent(t) {
          ...
          n.a.each(i, (t, e) => {
            const o = y.head(e);
            ut.isLi(o) ? this.releaseList([e]) : n.a.each(e, (t, e) => {
        ...
        toggleList(t, e) {
          const o = bt.create(e).wrapBodyInlineWithPara();
          let i = o.nodes(ut.isPara, {includeAncestor: !0});
          const s = o.paraBookmark(i), r = y.clusterBy(i, b.peq2("parentNode"));
          if (y.find(i, ut.isPurePara)) {
            ...
            const e = o.nodes(ut.isList, {includeAncestor: !0}).filter(e => !n.a.nodeName(e, t));
        ...
        wrapList(t, e) {
          const o = y.head(t), i = y.last(t), n = ut.isList(o.previousSibling) && o.previousSibling,
            s = ut.isList(i.nextSibling) && i.nextSibling, r = n || ut.insertAfter(ut.create(e || "UL"), i);
          return t = t.map(t => ut.isPurePara(t) ? ut.replace(t, "LI") : t), ut.appendChildNodes(r, t), s && (ut.appendChildNodes(r, y.from(s.childNodes)), ut.remove(s)), t
        }

        releaseList(t, e) {
          let o = [];
          return n.a.each(t, (t, i) => {
            const s = y.head(i), r = y.last(i), a = e ? ut.lastAncestor(s, ut.isList) : s.parentNode, l = a.parentNode;
            if ("LI" === a.parentNode.nodeName) i.map(t => {
              ...
              const t = a.childNodes.length > 1 ? ut.splitTree(a, {
                  node: r.parentNode,
                  offset: ut.position(r) + 1
                }, {isSkipPaddingBlankHTML: !0}) : null,
                o = ut.splitTree(a, {node: s.parentNode, offset: ut.position(s)}, {isSkipPaddingBlankHTML: !0});
              i = e ? ut.listDescendant(o, ut.isLi) : y.from(o.childNodes).filter(ut.isLi), !e && ut.isList(a.parentNode) || (i = i.map(t => ut.replace(t, "P"))), n.a.each(y.from(i).reverse(), (t, e) => {
                ut.insertAfter(e, a)
              });
              const l = y.compact([a, o, t]);
              n.a.each(l, (t, e) => {
                const o = [e].concat(ut.listDescendant(e, ut.isList));
        ...
        findList(t) {
          return t ? y.find(t.children, t => ["OL", "UL"].indexOf(t.nodeName) > -1) : null
        }
      ...
      class xt {
        ...
        insertTab(t, e) {
          const o = ut.createText(new Array(e + 1).join(ut.NBSP_CHAR));
          (t = t.deleteContents()).insertNode(o, !0), (t = bt.create(o, e)).select()
        }

        insertParagraph(t, e) {
          e = (e = (e = e || bt.create(t)).deleteContents()).wrapBodyInlineWithPara();
          const o = ut.ancestor(e.sc, ut.isPara);
          let i;
          if (o) {
            if (ut.isLi(o) && (ut.isEmpty(o) || ut.deepestChildIsEmpty(o))) return void this.bullet.toggleList(o.parentNode.nodeName);
            {
              let t = null;
              if (1 === this.options.blockquoteBreakingLevel ? t = ut.ancestor(o, ut.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (t = ut.lastAncestor(o, ut.isBlockquote)), t) {
                i = n()(ut.emptyPara)[0], ut.isRightEdgePoint(e.getStartPoint()) && ut.isBR(e.sc.nextSibling) && n()(e.sc.nextSibling).remove();
                const o = ut.splitTree(t, e.getStartPoint(), {isDiscardEmptySplits: !0});
                o ? o.parentNode.insertBefore(i, o) : ut.insertAfter(i, t)
              } else {
                i = ut.splitTree(o, e.getStartPoint());
                let t = ut.listDescendant(o, ut.isEmptyAnchor);
                t = t.concat(ut.listDescendant(i, ut.isEmptyAnchor)), n.a.each(t, (t, e) => {
                  ut.remove(e)
            ...
            i = n()(ut.emptyPara)[0], t ? e.sc.insertBefore(i, t) : e.sc.appendChild(i)
          }
          bt.create(i, 0).normalize().select().scrollIntoView(t)
        }
      }

      const St = function (t, e, o, i) {
        const n = {colPos: 0, rowPos: 0}, s = [], r = [];

        function a(t, e, o, i, n, r, a) {
          const l = {baseRow: o, baseCell: i, isRowSpan: n, isColSpan: r, isVirtual: a};
          s[t] || (s[t] = []), s[t][e] = l
        }

        function l(t, e, o, i) {
          return {baseCell: t.baseCell, action: e, virtualTable: {rowIndex: o, cellIndex: i}}
        }
        ...
        function c(t, e) {
          ...
          if (!s[t][e]) return e;
          let o = e;
          for (; s[t][o];) if (o++, !s[t][o]) return o
        }

        function h(t, e) {
          const o = c(t.rowIndex, e.cellIndex), i = e.colSpan > 1, s = e.rowSpan > 1,
        ...
        this.getActionList = function () {
          const t = e === St.where.Row ? n.rowPos : -1, i = e === St.where.Column ? n.colPos : -1;
          let a = 0, c = !0;
          for (; c;) {
            const e = t >= 0 ? t : a, n = i >= 0 ? i : a, h = s[e];
            if (!h) return c = !1, r;
            const d = h[n];
            if (!d) return c = !1, r;
            let m = St.resultAction.Ignore;
            switch (o) {
      ...
      St.where = {Row: 0, Column: 1}, St.requestAction = {Add: 0, Delete: 1}, St.resultAction = {
        Ignore: 0,
        SubtractSpanCount: 1,
        RemoveCell: 2,
        AddCell: 3,
      ...
      class $t {
        tab(t, e) {
          const o = ut.ancestor(t.commonAncestor(), ut.isCell), i = ut.ancestor(o, ut.isTable),
            n = ut.listDescendant(i, ut.isCell), s = y[e ? "prev" : "next"](n, o);
          s && bt.create(s, 0).select()
        }

        addRow(t, e) {
          const o = ut.ancestor(t.commonAncestor(), ut.isCell), i = n()(o).closest("tr"), s = this.recoverAttributes(i),
            r = n()("<tr" + s + "></tr>"),
            a = new St(o, St.where.Row, St.requestAction.Add, n()(i).closest("table")[0]).getActionList();
          for (let t = 0; t < a.length; t++) {
            const o = a[t], s = this.recoverAttributes(o.baseCell);
            switch (o.action) {
              case St.resultAction.AddCell:
                r.append("<td" + s + ">" + ut.blank + "</td>");
                break;
              case St.resultAction.SumSpanCount:
                if ("top" === e) {
                  if ((o.baseCell.parent ? o.baseCell.closest("tr").rowIndex : 0) <= i[0].rowIndex) {
                    const t = n()("<div></div>").append(n()("<td" + s + ">" + ut.blank + "</td>").removeAttr("rowspan")).html();
                    r.append(t);
                    break
                  }
                }
        ...
        addCol(t, e) {
          const o = ut.ancestor(t.commonAncestor(), ut.isCell), i = n()(o).closest("tr");
          n()(i).siblings().push(i);
          const s = new St(o, St.where.Column, St.requestAction.Add, n()(i).closest("table")[0]).getActionList();
          for (let t = 0; t < s.length; t++) {
            const o = s[t], i = this.recoverAttributes(o.baseCell);
            switch (o.action) {
              case St.resultAction.AddCell:
                "right" === e ? n()(o.baseCell).after("<td" + i + ">" + ut.blank + "</td>") : n()(o.baseCell).before("<td" + i + ">" + ut.blank + "</td>");
                break;
              case St.resultAction.SumSpanCount:
                if ("right" === e) {
                  let t = parseInt(o.baseCell.colSpan, 10);
                  t++, o.baseCell.setAttribute("colSpan", t)
                } else n()(o.baseCell).before("<td" + i + ">" + ut.blank + "</td>")
            }
          }
        }
        ...
        deleteRow(t) {
          const e = ut.ancestor(t.commonAncestor(), ut.isCell), o = n()(e).closest("tr"),
            i = o.children("td, th").index(n()(e)), s = o[0].rowIndex,
            r = new St(e, St.where.Row, St.requestAction.Delete, n()(o).closest("table")[0]).getActionList();
          for (let t = 0; t < r.length; t++) {
            if (!r[t]) continue;
            const e = r[t].baseCell, n = r[t].virtualTable, a = e.rowSpan && e.rowSpan > 1;
            ...
            switch (r[t].action) {
              ...
              case St.resultAction.AddCell:
                ...
                if (!t) continue;
                const r = o[0].cells[i];
                a && (l > 2 ? (l--, t.insertBefore(r, t.cells[i]), t.cells[i].setAttribute("rowSpan", l), t.cells[i].innerHTML = "") : 2 === l && (t.insertBefore(r, t.cells[i]), t.cells[i].removeAttribute("rowSpan"), t.cells[i].innerHTML = ""));
                continue;
        ...
        deleteCol(t) {
          ...
          for (let t = 0; t < s.length; t++) if (s[t]) switch (s[t].action) {
            case St.resultAction.Ignore:
              continue;
            case St.resultAction.SubtractSpanCount:
        ...
        createTable(t, e, o) {
          const i = [];
          let s;
          for (let e = 0; e < t; e++) i.push("<td>" + ut.blank + "</td>");
          s = i.join("");
          const r = [];
          let a;
        ...
        deleteTable(t) {
          const e = ut.ancestor(t.commonAncestor(), ut.isCell);
      ...
      const Tt = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|tel:|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i;
      n.a.summernote = n.a.extend(n.a.summernote, {
        version: "0.8.15", plugins: {}, dom: ut, range: bt, lists: y, options: {
          langInfo: n.a.summernote.lang["zh-CN"],
          editing: !0,
          modules: {
            editor: class {
              constructor(t) {
                ...
                this.fontName = this.wrapCommand(t => this.fontStyling("font-family", f.validFontName(t))), this.fontSize = this.wrapCommand(t => {
                  const e = this.currentStyle()["font-size-unit"];
                  return this.fontStyling("font-size", t + e)
                }), this.fontSizeUnit = this.wrapCommand(t => {
                  const e = this.currentStyle()["font-size"];
                  return this.fontStyling("font-size", e + t)
                });
                ...
                this.insertParagraph = this.wrapCommand(() => {
                  ...
                  if (this.isLimited(n()(t).text().length)) return;
                  this.getLastRange().insertNode(t), this.setLastRange(bt.createFromNodeAfter(t).select())
                }), this.insertText = this.wrapCommand(t => {
                  if (this.isLimited(t.length)) return;
                  const e = this.getLastRange().insertNode(ut.createText(t));
                  this.setLastRange(bt.create(e, ut.nodeLength(e)).select())
                }), this.pasteHTML = this.wrapCommand(t => {
                  if (this.isLimited(t.length)) return;
                  t = this.context.invoke("codeview.purify", t);
                  const e = this.getLastRange().pasteHTML(t);
                  this.setLastRange(bt.createFromNodeAfter(y.last(e)).select())
                  ...
                  const t = this.getLastRange().insertNode(ut.create("HR"));
                  t.nextSibling && this.setLastRange(bt.create(t.nextSibling, 0).normalize().select())
                }), this.lineHeight = this.wrapCommand(t => {
                  this.style.stylePara(this.getLastRange(), {lineHeight: t})
                }), this.createLink = this.wrapCommand(t => {
                  let e = t.url;
                  const o = t.text, i = t.isNewWindow, s = t.checkProtocol;
                  let r = t.range || this.getLastRange();
                  const a = o.length - r.toString().length;
                  if (a > 0 && this.isLimited(a)) return;
                  const l = r.toString() !== o;
                  "string" == typeof e && (e = e.trim()), this.options.onCreateLink ? e = this.options.onCreateLink(e) : s && (e = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(e) ? e : this.options.defaultProtocol + e);
                  let c = [];
                  if (l) {
                    r = r.deleteContents();
                    const t = r.insertNode(n()("<A>" + o + "</A>")[0]);
                    c.push(t)
                  } else c = this.style.styleNodes(r, {
                    nodeName: "A",
                  ...
                  const h = bt.createFromNodeBefore(y.head(c)).getStartPoint(),
                    d = bt.createFromNodeAfter(y.last(c)).getEndPoint();
                  this.setLastRange(bt.create(h.node, h.offset, d.node, d.offset).select())
                }), this.color = this.wrapCommand(t => {
                  const e = t.foreColor, o = t.backColor;
                  ...
                  t.closest("figure").length ? t.closest("figure").remove() : t = n()(this.restoreTarget()).detach(), this.context.triggerEvent("media.delete", t, this.$editable)
              ...
              initialize() {
                this.$editable.on("keydown", t => {
                  if (t.keyCode === kt.code.ENTER && this.context.triggerEvent("enter", t), this.context.triggerEvent("keydown", t), this.snapshot = this.history.makeSnapshot(), t.isDefaultPrevented() || (this.options.shortcuts ? this.handleKeyMap(t) : this.preventDefaultEditableShortCuts(t)), this.isLimited(1, t)) {
                ...
                }), this.$editable.attr("spellcheck", this.options.spellCheck), this.$editable.attr("autocorrect", this.options.spellCheck), this.options.disableGrammar && this.$editable.attr("data-gramm", !1), this.$editable.html(ut.html(this.$note) || ut.emptyPara), this.$editable.on(f.inputEventName, b.debounce(() => {
              ...
              handleKeyMap(t) {
                const e = this.options.keyMap[f.isMac ? "mac" : "pc"], o = [];
                t.metaKey && o.push("CMD"), t.ctrlKey && !t.altKey && o.push("CTRL"), t.shiftKey && o.push("SHIFT");
                const i = kt.nameFromCode[t.keyCode];
                i && o.push(i);
                const n = e[o.join("+")];
              ...
              insertImage(t, e) {
                return (o = t, n.a.Deferred(t => {
                  ...
                  this.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", Math.min(this.$editable.width(), t.width()))), t.show(), this.getLastRange().insertNode(t[0]), this.setLastRange(bt.createFromNodeAfter(t[0]).select()), this.afterCommand()
                }).fail(t => {
              ...
              fontStyling(t, e) {
                ...
                if ("" !== o) {
                  ...
                  if (this.$editor.find(".note-status-output").html(""), n()(i).css(t, e), o.isCollapsed()) {
                    const t = y.head(i);
                    t && !ut.nodeLength(t) && (t.innerHTML = ut.ZERO_WIDTH_NBSP_CHAR, bt.createFromNodeAfter(t.firstChild).select(), this.setLastRange(), this.$editable.data("bogus", t))
                  }
                } else {
                  const t = n.a.now();
                  this.$editor.find(".note-status-output").html('<div id="note-status-output-' + t + '" class="alert alert-info">' + this.lang.output.noSelection + "</div>"), setTimeout((function () {
                    n()("#note-status-output-" + t).remove()
                  }), 5e3)
                }
              }
              ...
              unlink() {
                let t = this.getLastRange();
                if (t.isOnAnchor()) {
                  const e = ut.ancestor(t.sc, ut.isAnchor);
                  t = bt.createFromNode(e), t.select(), this.setLastRange(), this.beforeCommand(), document.execCommand("unlink"), this.afterCommand()
                }
              }

              getLinkInfo() {
                const t = this.getLastRange().expand(ut.isAnchor), e = n()(y.head(t.nodes(ut.isAnchor))),
                  o = {range: t, text: t.toString(), url: e.length ? e.attr("href") : ""};
              ...
              resizeTo(t, e, o) {
                let i;
                if (o) {
                  const o = t.y / t.x, n = e.data("ratio");
                  i = {width: n > o ? t.x : t.y / n, height: n > o ? t.x * n : t.y}
                } else i = {width: t.x, height: t.y};
                e.css(i)
              }
              ...
              pasteByEvent(t) {
                ...
                if (e && e.items && e.items.length) {
                  const o = e.items.length > 1 ? e.items[1] : y.head(e.items);
                  "file" === o.kind && -1 !== o.type.indexOf("image/") ? (this.context.invoke("editor.insertImagesOrCallback", [o.getAsFile()]), t.preventDefault(), this.context.invoke("editor.afterCommand")) : "string" === o.kind && (this.context.invoke("editor.isLimited", e.getData("Text").length) ? t.preventDefault() : this.context.invoke("editor.afterCommand"))
                }
              }
            }, dropzone: class {
              constructor(t) {
              ...
              attachDragAndDropEvent() {
                ...
                this.documentEventHandlers.onDragenter = o => {
                  ...
                  t = t.not(e.target), t.length && "BODY" !== e.target.nodeName || (t = n()(), this.$editor.removeClass("dragover"))
              ...
              purify(t) {
                if (this.options.codeviewFilter && (t = t.replace(this.options.codeviewFilterRegex, ""), this.options.codeviewIframeFilter)) {
                  ...
                  t = t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, (function (t) {
                    ...
                    for (const o of e) if (new RegExp('src="(https?:)?//' + o.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + '/(.+)"').test(t)) return t;
                    return ""
                  }))
                }
                return t
              ...
              activate() {
                if (this.$codable.val(ut.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), f.hasCodeMirror) {
                  const t = It.fromTextArea(this.$codable[0], this.options.codemirror);
                  if (this.options.codemirror.tern) {
                    const e = new It.TernServer(this.options.codemirror.tern);
              ...
              deactivate() {
                ...
                const t = this.purify(ut.value(this.$codable, this.options.prettifyHtml) || ut.emptyPara),
              ...
              initialize() {
                this.options.airMode || this.options.disableResizeEditor ? this.destroy() : this.$statusbar.on("mousedown", t => {
                  ...
                  const e = this.$editable.offset().top - this.$document.scrollTop(), o = t => {
                    let o = t.clientY - (e + 24);
              ...
              constructor(t) {
                this.context = t, this.$editor = t.layoutInfo.editor, this.$toolbar = t.layoutInfo.toolbar, this.$editable = t.layoutInfo.editable, this.$codable = t.layoutInfo.codable, this.$window = n()(window), this.$scrollbar = n()("html, body"), this.onResize = () => {
                  this.resizeTo({h: this.$window.height() - this.$toolbar.outerHeight()})
                }
              }
              ...
              initialize() {
                this.$handle = n()(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', this.options.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', this.options.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(this.$editingArea), this.$handle.on("mousedown", t => {
                  if (ut.isControlSizing(t.target)) {
                    t.preventDefault(), t.stopPropagation();
                    const e = this.$handle.find(".note-control-selection").data("target"), o = e.offset(),
              ...
              update(t, e) {
                ...
                const o = ut.isImg(t), i = this.$handle.find(".note-control-selection");
                if (this.context.invoke("imagePopover.update", t, e), o) {
                  const e = n()(t), o = e.position(), s = {
                    left: o.left + parseInt(e.css("marginLeft"), 10),
                    top: o.top + parseInt(e.css("marginTop"), 10)
                  }, r = {w: e.outerWidth(!1), h: e.outerHeight(!1)};
                  i.css({display: "block", left: s.left, top: s.top, width: r.w, height: r.h}).data("target", e);
                  const a = new Image;
                  a.src = e.attr("src");
              ...
              replace() {
                ...
                if (t.length) {
                  ...
                  if (null !== this.matchingWord && 0 === this.matchingWord.length) this.lastWordRange.so = this.lastWordRange.eo; else if (null !== this.matchingWord && this.matchingWord.length > 0 && !this.lastWordRange.isCollapsed()) {
                    let t = this.lastWordRange.eo - this.lastWordRange.so - this.matchingWord.length;
                    t > 0 && (this.lastWordRange.so += t)
                  }
              ...
              createItemTemplates(t, e) {
                ...
                return e.map((e, i) => {
                  ...
                  return s.append(o.template ? o.template(e) : e + ""), s.data({index: t, item: e}), s
                })
              }
              ...
              searchKeyword(t, e, o) {
                ...
                if (i && i.match.test(e) && i.search) {
                  ...
                  this.matchingWord = t[0], i.search(t[1], o)
                } else o()
              }
              ...
              handleKeyup(t) {
                if (!y.contains([kt.code.ENTER, kt.code.UP, kt.code.DOWN], t.keyCode)) {
                  let t, e, o = this.context.invoke("editor.getLastRange");
                  if ("words" === this.options.hintMode) {
                    if (t = o.getWordsRange(o), e = t.toString(), this.hints.forEach(i => {
                      if (i.match.test(e)) return t = o.getWordsMatchRange(i.match), !1
                    }), !t) return void this.hide();
                    e = t.toString()
                  } else t = o.getWordRange(), e = t.toString();
                  if (this.hints.length && e) {
                    this.$content.empty();
                    const o = b.rect2bnd(y.last(t.getClientRects())), i = n()(this.options.container).offset();
                    o && (o.top -= i.top, o.left -= i.left, this.$popover.hide(), this.lastWordRange = t, this.hints.forEach((t, o) => {
                    ...
                    }) : this.$popover.css({left: o.left, top: o.top + o.height + 5}))
                  } else this.hide()
                }
              }
              ...
              replace() {
                ...
                const t = this.lastWordRange.toString(), e = t.match(Tt);
                if (e && (e[1] || e[2])) {
                  const o = e[1] ? t : "http://" + t,
                    i = t.replace(/^(?:https?:\/\/)?(?:tel?:?)?(?:mailto?:?)?(?:www\.)?/i, "").split("/")[0],
                    s = n()("<a />").html(i).attr("href", o)[0];
                  this.context.options.linkTargetBlank && n()(s).attr("target", "_blank"), this.lastWordRange.insertNode(s), this.lastWordRange = null, this.context.invoke("editor.focus")
                }
              }
              ...
              replace() {
                ...
                this.options.match(e, (function (e) {
                  if (e) {
                    let o = "";
                    if ("string" == typeof e ? o = ut.createText(e) : e instanceof jQuery ? o = e[0] : e instanceof Node && (o = e), !o) return;
                ...
                return this.ui.buttonGroup({
                  ...
                  children: [this.button({
                    ...
                    click: t => {
                      ...
                      }) : o ? this.context.invoke("editor.color", {backColor: e.attr("data-backColor")}) : i && this.context.invoke("editor.color", {foreColor: e.attr("data-foreColor")})
                    },
                    callback: t => {
                    ...
                    click: e => {
                      e.stopPropagation();
                      const o = n()("." + t).find(".show"), i = n()(e.target), s = i.data("event");
                      let r = i.attr("data-value");
                      if ("openPalette" === s) {
                        const t = o.find("#" + r), e = n()(o.find("#" + t.data("event")).find(".note-color-row")[0]),
                          i = e.find(".note-color-btn").last().detach(), s = t.val();
              ...
              addToolbarButtons() {
                ...
                })]).render()), this.context.memo("button.fontsizeunit", () => this.ui.buttonGroup([this.button({
                  className: "dropdown-toggle",
              ...
              build(t, e) {
                for (let o = 0, i = e.length; o < i; o++) {
                  const i = e[o], n = Array.isArray(i) ? i[0] : i,
                    s = Array.isArray(i) ? 1 === i.length ? [i[0]] : i[1] : [i],
                    r = this.ui.buttonGroup({className: "note-" + n}).render();
              ...
              updateCurrentStyle(t) {
                ...
                if (this.updateBtnStates(e, {
                  ...
                  const t = o["font-family"].split(",").map(t => t.replace(/[\'\"]/g, "").replace(/\s+$/, "").replace(/^\s+/, "")),
                    i = y.find(t, this.isFontInstalled.bind(this));
                  e.find(".dropdown-fontname a").each((t, e) => {
                    const o = n()(e), s = o.data("value") + "" == i + "";
                ...
                if (o["font-size"]) {
                  ...
                  e.find(".dropdown-fontsize a").each((e, o) => {
                    const i = n()(o), s = i.data("value") + "" == t + "";
                    i.toggleClass("checked", s)
                  }), e.find(".note-current-fontsize").text(t);
                  const i = o["font-size-unit"];
                  e.find(".dropdown-fontsizeunit a").each((t, e) => {
                    const o = n()(e), s = o.data("value") + "" == i + "";
                    o.toggleClass("checked", s)
                  }), e.find(".note-current-fontsizeunit").text(i)
                }
                if (o["line-height"]) {
              ...
              tableMoveHandler(t) {
                const e = n()(t.target.parentNode), o = e.next(), i = e.find(".note-dimension-picker-mousecatcher"),
                  s = e.find(".note-dimension-picker-highlighted"), r = e.find(".note-dimension-picker-unhighlighted");
                let a;
                if (void 0 === t.offsetX) {
                  const e = n()(t.target).offset();
                  a = {x: t.pageX - e.left, y: t.pageY - e.top}
                } else a = {x: t.offsetX, y: t.offsetY};
                const l = Math.ceil(a.x / 18) || 1, c = Math.ceil(a.y / 18) || 1;
                s.css({
                  width: l + "em",
                  height: c + "em"
                }), i.data("value", l + "x" + c), l > 3 && l < this.options.insertTableMaxSize.col && r.css({width: l + 1 + "em"}), c > 3 && c < this.options.insertTableMaxSize.row && r.css({height: c + 1 + "em"}), o.html(l + " x " + c)
              }
            }, toolbar: class {
              constructor(t) {
              ...
              followScroll() {
                ...
                const t = this.$editor.outerHeight(), e = this.$editor.width(), o = this.$toolbar.height(),
                  i = this.$statusbar.height();
                let s = 0;
                this.options.otherStaticBar && (s = n()(this.options.otherStaticBar).outerHeight());
                const r = this.$document.scrollTop(), a = this.$editor.offset().top, l = a - s, c = a + t - s - o - i;
                !this.isFollowing && r > l && r < c - o ? (this.isFollowing = !0, this.$toolbar.css({
                  position: "fixed",
                  top: s,
                  width: e,
                  zIndex: 1e3
                }), this.$editable.css({marginTop: this.$toolbar.height() + 5})) : this.isFollowing && (r < l || r > c) && (this.isFollowing = !1, this.$toolbar.css({
                  position: "relative",
                  top: 0,
                  width: "100%",
                  zIndex: "auto"
              ...
              initialize() {
                const t = this.options.dialogsInBody ? this.$body : this.options.container,
              ...
              showLinkDialog(t) {
                return n.a.Deferred(e => {
                  const o = this.$dialog.find(".note-link-text"), i = this.$dialog.find(".note-link-url"),
                    n = this.$dialog.find(".note-link-btn"),
                    s = this.$dialog.find(".sn-checkbox-open-in-new-window input[type=checkbox]"),
                    r = this.$dialog.find(".sn-checkbox-use-protocol input[type=checkbox]");
                  this.ui.onDialogShown(this.$dialog, () => {
                    ...
                    const a = void 0 !== t.isNewWindow ? t.isNewWindow : this.context.options.linkTargetBlank;
                    s.prop("checked", a);
                    const l = !t.url && this.context.options.useProtocol;
                    r.prop("checked", l), n.one("click", n => {
              ...
              initialize() {
                this.$popover = this.ui.popover({
                  className: "note-link-popover", callback: t => {
                ...
                this.context.invoke("buttons.build", t, this.options.popover.link), this.$popover.on("mousedown", t => {
                  t.preventDefault()
                })
              }
              ...
              update() {
                ...
                if (t.isCollapsed() && t.isOnAnchor()) {
                  const e = ut.ancestor(t.sc, ut.isAnchor), o = n()(e).attr("href");
                  this.$popover.find("a").attr("href", o).html(o);
                  const i = ut.posFromPlaceholder(e), s = n()(this.options.container).offset();
                  i.top -= s.top, i.left -= s.left, this.$popover.css({display: "block", left: i.left, top: i.top})
                } else this.hide()
              }
              ...
              initialize() {
                ...
                if (this.options.maximumImageFileSize) {
                  const e = Math.floor(Math.log(this.options.maximumImageFileSize) / Math.log(1024)),
                    o = 1 * (this.options.maximumImageFileSize / Math.pow(1024, e)).toFixed(2) + " " + " KMGTP"[e] + "B";
                  t = `<small>${this.lang.image.maximumFileSize + " : " + o}</small>`
                }
                const e = this.options.dialogsInBody ? this.$body : this.options.container,
              ...
              showImageDialog() {
                return n.a.Deferred(t => {
                  const e = this.$dialog.find(".note-image-input"), o = this.$dialog.find(".note-image-url"),
              ...
              initialize() {
                ...
                const t = this.$popover.find(".popover-content,.note-popover-content");
                this.context.invoke("buttons.build", t, this.options.popover.image), this.$popover.on("mousedown", t => {
                  t.preventDefault()
                })
              }
              ...
              update(t, e) {
                if (ut.isImg(t)) {
                  const o = n()(t).offset(), i = n()(this.options.container).offset();
                  let s = {};
                  this.options.popatmouse ? (s.left = e.pageX - 20, s.top = e.pageY) : s = o, s.top -= i.top, s.left -= i.left, this.$popover.css({
                    display: "block",
                    left: s.left,
                    top: s.top
                  })
              ...
              initialize() {
                ...
                const t = this.$popover.find(".popover-content,.note-popover-content");
                this.context.invoke("buttons.build", t, this.options.popover.table), f.isFF && document.execCommand("enableInlineTableEditing", !1, !1), this.$popover.on("mousedown", t => {
                  t.preventDefault()
                })
              }
              ...
              update(t) {
                ...
                const e = ut.isCell(t);
                if (e) {
                  const e = ut.posFromPlaceholder(t), o = n()(this.options.container).offset();
                  e.top -= o.top, e.left -= o.left, this.$popover.css({display: "block", left: e.left, top: e.top})
                } else this.hide();
                return e
              }
              ...
              createVideoNode(t) {
                const e = /^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/,
                  ...
                  d = t.match(/^.+.(mp4|m4v)$/), u = t.match(/^.+.(ogg|ogv)$/), p = t.match(/^.+.(webm)$/),
                ...
                if (o && 11 === o[1].length) {
                  ...
                  if (void 0 !== o[2]) {
                    const t = o[2].match(e);
                    if (t) for (var b = [3600, 60, 1], v = 0, k = b.length; v < k; v++) g += void 0 !== t[v + 1] ? b[v] * parseInt(t[v + 1], 10) : 0
                  }
                  ...
                  f = n()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "500").attr("src", "https://v.qq.com/iframe/player.html?vid=" + t + "&amp;auto=0")
              ...
              createShortcutList() {
                ...
                return Object.keys(t).map(e => {
                  const o = t[e], i = n()('<div><div class="help-list-item"/></div>');
              ...
              constructor(t) {
                this.context = t, this.ui = n.a.summernote.ui, this.options = t.options, this.hidable = !0, this.events = {
                  "summernote.keyup summernote.mouseup summernote.scroll": () => {
                    this.options.editing && this.update()
              ...
              update() {
                ...
                if (t.range && !t.range.isCollapsed()) {
                  const e = y.last(t.range.getClientRects());
                  if (e) {
                    const t = b.rect2bnd(e);
                    this.$popover.css({
                      display: "block",
                      left: Math.max(t.left + t.width / 2, 0) - 20,
                      top: t.top + t.height
      ...
      "use strict";
      o.r(e);
      var i = o(0), n = o.n(i), s = o(1);
      const r = s.a.create('<div class="note-editor note-frame panel panel-default"/>'),
        ...
        f = s.a.create('<ul class="note-dropdown-menu dropdown-menu">', (function (t, e) {
          const o = Array.isArray(e.items) ? e.items.map((function (t) {
            const o = "string" == typeof t ? t : t.value || "", i = e.template ? e.template(t) : t,
        ...
        return {
          ...
          palette: function (e, o) {
            return s.a.create('<div class="note-color-palette"/>', (function (e, o) {
              const i = [];
              for (let t = 0, e = o.colors.length; t < e; t++) {
                const e = o.eventName, n = o.colors[t], s = o.colorsName[t], r = [];
                for (let t = 0, o = n.length; t < o; t++) {
                  const o = n[t], i = s[t];
                  r.push(['<button type="button" class="note-color-btn"', 'style="background-color:', o, '" ', 'data-event="', e, '" ', 'data-value="', o, '" ', 'title="', i, '" ', 'aria-label="', i, '" ', 'data-toggle="button" tabindex="-1"></button>'].join(""))
                }
          ...
          createLayout: function (e) {
            const o = (t.airMode ? u([l([c(), p()])]) : "bottom" === t.toolbarPosition ? r([l([c(), h()]), a(), d()]) : r([a(), l([c(), h()]), d()])).render();
      ...
      o(3), o(4);
      n.a.summernote = n.a.extend(n.a.summernote, {ui_template: y, interface: "bs3"})
    }
  })
}));
