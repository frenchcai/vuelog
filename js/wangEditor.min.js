!function (e, t) {
    ...
    function l(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6">\n            <i class="w-e-icon-bold"></i>\n        </div>'), this.type = "click", this._active = !1
    }
    ...
    function u(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-header"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p>设置标题</p>"),
            type: "list",
    ...
    function h(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-text-heigh"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 160,
            $title: o("<p>字号</p>"),
            type: "list",
            list: [{
    ...
    function p(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-font"></i></div>'), this.type = "droplist", this._active = !1;
    ...
    function m(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-link"></i></div>'), this.type = "panel", this._active = !1
    }
    ...
    function B(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-list2"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>设置列表</p>"),
            type: "list",
            list: [{
    ...
    function y(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-paragraph-left"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p>对齐方式</p>"),
            type: "list",
            list: [{
    ...
    function C(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-pencil2"></i></div>'), this.type = "droplist";
    ...
    function x(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-paint-brush"></i></div>'), this.type = "droplist";
        var n = e.config, i = n.colors || [];
        this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>背景色</p>"),
    ...
    function S(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-table2"></i></div>'), this.type = "panel", this._active = !1
    }

    function k(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6"><i class="w-e-icon-play"></i></div>'), this.type = "panel", this._active = !1
    }

    function D(e) {
        this.editor = e;
        var t = c("w-e-img");
        this.$elem = o('<div class="w-e-menu col-lg-0.6 col-md-0.6 col-sm-0.6 col-xs-0.6" id="' + t + '"><i class="w-e-icon-image"></i></div>'), e.imgMenuId = t, this.type = "panel", this._active = !1
    }
    ...
    i.prototype = {
        constructor: i, forEach: function (e) {
            ...
            return (this.css("display","block")&this.css("z-index",9999))
        }, hide: function () {
    ...
    j.prototype = {
        constructor: j, _initConfig: function () {
            ...
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#f1f1f1").css("border", "1px solid #ccc"), s.css("border", "1px solid #ccc").css("border-top", "none").css("height", "300px")) : (a = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l),a.addClass("w-e-toolbar col-lg-12 col-md-12 col-sm-12 col-xs-12"), s.addClass("w-e-text-container"), s.css("z-index", r), l.addClass("w-e-text");
